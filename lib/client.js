// dsh-theme — browser half (client plugin bundle).
//
// Loaded by dsh-client-modules at /plugins/dsh-theme/client.js and
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const SIDEBAR_OPACITY_KEY = "dsh-theme:sidebar-opacity";
		...
		const SIDEBAR_LINK_KEY = "dsh-theme:sidebar-link";
		...
		const MODAL_OPACITY_KEY = "dsh-theme:modal-opacity";
		...
		const MODAL_FILL_VAR = "--dsh-theme-modal-fill";
		/**
		 ...
		 */
		const BUILTIN_LAST_KEY = "dsh-theme:builtin-last";
		...
		//#region dsh-theme: persistence (host-backed, origin-independent)
		/**
		...
		//#region dsh-theme: wallpaper layer + token shading
		 ...
		 */
		const COMBINED_OVERRIDE_SOURCE = "dsh-theme:appearance";
		...
		//#region dsh-theme: liquid-glass material CSS
		/**
		 ...
		 */
		const MATERIAL_CSS_SOURCE = "dsh-theme:material:liquid-glass";
		...
		//#region dsh-theme: image compression
		/**
		...
		//#region dsh-theme: settings row stores
		/**
		...
		//#region dsh-theme: settings rows
		...
		//#region dsh-theme: P0 shared utilities (packs, accent, persistence, random)
		/**
		...
		const PACK_FORMAT = "dsh-theme/pack";
		...
		const PACKS_KEY = "dsh-theme:packs"; // JSON array of remote/manual pack manifests
		const ACCENT_KEY = "dsh-theme:accent"; // hex accent (#rrggbb) or "system"
		const FAVORITES_KEY = "dsh-theme:favorites"; // JSON array of theme/ pack ids
		const WALLPAPER_URL_KEY = "dsh-theme:wallpaper-url";
		const WALLPAPER_KIND_KEY = "dsh-theme:wallpaper-kind"; // 'image'|'url'|'gradient'
		const WALLPAPER_GRADIENT_KEY = "dsh-theme:wallpaper-gradient";
		const WALLPAPER_AUTODIM_KEY = "dsh-theme:wallpaper-autodim"; // '1'|'0'
		...
		const WALLPAPER_FOLLOWS_SKIN_KEY = "dsh-theme:wallpaper-follows-skin";
		...
		//#region dsh-theme: P0 favorites + surprise-me
		...
		//#region dsh-theme: P0 stores + module hooks
		...
		//#region dsh-theme: P0 accent override
		...
		//#region dsh-theme: P0 wallpaper 2.0 (url / gradient / auto-dim)
		...
		//#region dsh-theme: P0 share-url import
		...
		//#region dsh-theme: P0 UI rows (accent + packs)
		...
		//#region dsh-theme: Appearance settings section
		/**
		...
		//#endregion
		//#region dsh-theme: client plugin body
		/**
		...
		function apply(ctx) {
			...
			}, "dsh-theme: sticky skin + built-in restore");
			...
			ctx.effect(() => () => {
				...
				combinedOverrideDispose?.();
				combinedOverrideDispose = null;
			}, "dsh-theme: wallpaper + material + packs cleanup");
			...
			ctx.effect(() => () => {
				if (wallpaperReshadeTimer !== null) clearTimeout(wallpaperReshadeTimer);
			}, "dsh-theme: deferred wallpaper re-shade");
			...
			ctx.effect(() => ctx.locale.register(SETTINGS_NS, {
				...
				de,
				ru
			}), "dsh-theme: settings row dictionaries");
